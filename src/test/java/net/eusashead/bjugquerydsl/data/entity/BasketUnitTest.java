...
public class BasketUnitTest {
    ...
    private Basket defaultInstance;
    private Basket randomInstance;
    private Basket clone;
    private Basket unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = BasketTestUtils.createDefaultInstance();
        this.randomInstance = BasketTestUtils.createRandomInstance();
        this.clone = BasketTestUtils.clone(defaultInstance);
        this.unitialized = new Basket();
