...
public class StockKeepingUnitUnitTest {
    
    private StockKeepingUnit defaultInstance;
    private StockKeepingUnit randomInstance;
    private StockKeepingUnit clone;
    private StockKeepingUnit unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = StockKeepingUnitTestUtils.createDefaultInstance();
        this.randomInstance = StockKeepingUnitTestUtils.createRandomInstance();
        this.clone = StockKeepingUnitTestUtils.clone(defaultInstance);
        this.unitialized = new StockKeepingUnit();
