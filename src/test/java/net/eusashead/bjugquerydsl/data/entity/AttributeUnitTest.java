...
public class AttributeUnitTest {
    ...
    private Attribute defaultInstance;
    private Attribute randomInstance;
    private Attribute clone;
    private Attribute unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = AttributeTestUtils.createDefaultInstance();
        this.randomInstance = AttributeTestUtils.createRandomInstance();
        this.clone = AttributeTestUtils.clone(defaultInstance);
        this.unitialized = new Attribute();
