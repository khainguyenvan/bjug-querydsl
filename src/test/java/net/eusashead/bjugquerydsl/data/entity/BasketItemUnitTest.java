...
public class BasketItemUnitTest {
    
    private BasketItem defaultInstance;
    private BasketItem randomInstance;
    private BasketItem clone;
    private BasketItem unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = BasketItemTestUtils.createDefaultInstance();
        this.randomInstance = BasketItemTestUtils.createRandomInstance();
        this.clone = BasketItemTestUtils.clone(defaultInstance);
        this.unitialized = new BasketItem();
