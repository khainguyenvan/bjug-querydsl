...
public class ProductUnitTest {
    ...
    private Product defaultInstance;
    private Product randomInstance;
    private Product clone;
    private Product unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = ProductTestUtils.createDefaultInstance();
        this.randomInstance = ProductTestUtils.createRandomInstance();
        this.clone = ProductTestUtils.clone(defaultInstance);
        this.unitialized = new Product();
