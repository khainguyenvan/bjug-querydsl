...
public class InventoryUnitTest {
    ...
    private Inventory defaultInstance;
    private Inventory randomInstance;
    private Inventory clone;
    private Inventory unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = InventoryTestUtils.createDefaultInstance();
        this.randomInstance = InventoryTestUtils.createRandomInstance();
        this.clone = InventoryTestUtils.clone(defaultInstance);
        this.unitialized = new Inventory();
