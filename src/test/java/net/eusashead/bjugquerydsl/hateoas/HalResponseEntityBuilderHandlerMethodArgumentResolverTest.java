...
public class HalResponseEntityBuilderHandlerMethodArgumentResolverTest {
	...
	public void testSupport() throws Exception {
		HalResponseEntityBuilderHandlerMethodArgumentResolver resolver = new HalResponseEntityBuilderHandlerMethodArgumentResolver(representationFactory, converter);
	...
	public void testResolve() throws Exception {
		...
		Assert.assertEquals(HalResponseEntityBuilder.class, resolved.getClass());
	}
	...
	private MethodParameter mockMethodParameter() {
		...
		doReturn(HalResponseEntityBuilder.class).when(parameter).getParameterType();
		return parameter;
	}
