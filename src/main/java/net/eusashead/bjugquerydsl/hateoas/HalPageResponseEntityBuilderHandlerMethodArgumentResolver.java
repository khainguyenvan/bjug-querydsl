 ...
 *
 */
public class HalPageResponseEntityBuilderHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter parameter,
		...
		return new HalPageResponseEntityBuilder(
	...
	public boolean supportsParameter(MethodParameter parameter) {
		return HalPageResponseEntityBuilder.class.equals(parameter.getParameterType());
	}
